...
export default function Reviewsecond() {
  ...
  return (
    <Grid>
      ...
      <Grid item xs={4}>
      <Button variant="contained" onClick={() => navigate('/checkout2')}  style={{maxWidth:'170px',maxHeight:'30px',minWidth:'170px',minHeight:'30px',marginTop:'10px',marginLeft:'10px',backgroundColor:'rgb(62 114 62)'}}>
          Change address
      </Button>
      </Grid>
    </Paper>
